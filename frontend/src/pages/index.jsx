...
import MyImage from '../../public/assets/images/gallery_9.jpeg'
import MyImage2 from '../../public/assets/images/gallery_8.jpeg'
import MyImage3 from '../../public/assets/images/gallery_7.jpeg'
import MyImage4 from '../../public/assets/images/gallery_6.jpeg'
import Person1 from '../../public/assets/images/person_1.jpg'
import hero1 from '../../public/assets/images/hero_1.jpeg'
function index(props) {
  return (
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12 text-center menu-1 menu-wrap">
						<ul>
							<li class="active"><a href="index.html">{props.home}</a></li>
							<li><a href="menu.html">{props.menu}</a></li>
							<li class="has-dropdown">
								<a href="gallery.html">{props.gallery}</a>
								<ul class="dropdown">
									<li><a href="#">{props.Event}</a></li>
									<li><a href="#">{props.Food}</a></li>
									<li><a href="#">{props.Coffee}</a></li>
								</ul>
							</li>
	...
	<header id="fh5co-header" className="fh5co-cover js-fullheight" role="banner" style={{"background-image": "url(../../public/assets/images/hero_1.jpeg)"}} data-stellar-background-ratio="0.5">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-pull-4 img-wrap animate-box" data-animate-effect="fadeInLeft">
					<img src={hero1} alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co"/>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
					<div class="fh5co-item">
						<img src={MyImage} class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co"/>
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
					<div class="fh5co-item margin_top">
						<img src={MyImage2} class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co"/>
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
					<div class="fh5co-item">
						<img src={MyImage3} class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co"/>
				...
				<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
					<div class="fh5co-item margin_top">
						<img src={MyImage4} class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co"/>
				...
				<div class="col-md-6 col-md-push-1 animate-box">
					...
					<div class="flexslider">
						<ul class="slides">
					   	...
					   	<li style={{"background-image": "url(../../public/assets/images/gallery_6.jpeg)"}}>
					   		<div class="overlay-gradient"></div>
					   		<div class="container-fluid">
					   			<div class="row">
						   			<div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
					   	...
					   	<li style={{"background-image": "url(../../public/assets/images/gallery_5.jpeg)"}}>
					   		<div class="overlay-gradient"></div>
					   		<div class="container-fluid">
					   			<div class="row">
						   			<div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
